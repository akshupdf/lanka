...
function Newadmin () {
    ...
    const edit = (id) => {
        ...
        fetch("https://lankanew.onrender.com/admin/" +empid, {
            method: "PUT",
            headers:{"content-type":"application/json"},
    ...
    useEffect(()=>{
        fetch("https://lankanew.onrender.com/admin/" + id).then((res)=>{
            return res.json()
        }).then((resp)=>{
            idchange(resp.id);
    ...
    const showData = () => {
    axios.get("https://lankanew.onrender.com/admin/" + id).then((response) => {
